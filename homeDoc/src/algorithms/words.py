...
def phonex(word):
    ...
    # replace à â by a
    word = word.replace(r'â', 'a')
    word = word.replace(r'à', 'a')
    # replace é, è, er, ez, et, by e
    word = word.replace(r'é', 'e')
    word = word.replace(r'è', 'e')
    word = word.replace(r'ê', 'e')
    word = word.replace(r'ë', 'e')
    word = word.replace(r'er', 'e')
    word = word.replace(r'ez', 'e')
    word = word.replace(r'et', 'e')
    # replace ï î by i
    word = word.replace(r'ï', 'i')
    word = word.replace(r'î', 'i')
    # replace ö ô by o
    word = word.replace(r'au', 'o')
    word = word.replace(r'eau', 'o')
    word = word.replace(r'ö', 'o')
    word = word.replace(r'ô', 'o')
    # replace û ü by u
    word = word.replace(r'û', 'u')
    word = word.replace(r'ü', 'u')
    word = word.replace(r'ù', 'u')
    # replace y by i
    word = word.replace(r'y', 'i')
    # replace ç by s
    word = word.replace(r'ç', 'c')
